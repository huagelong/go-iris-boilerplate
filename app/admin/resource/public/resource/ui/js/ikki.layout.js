...
function lockScreen() {
    ...
    if (sessionStorage.getItem("avatar")) {
        ...
        $('body').append('<div id="locking"><figure onclick="logout();"><img src="/resource/ui/img/avatar.png" alt="IKKI"></figure><h3>你没有正常登录哦~</h3></div>');
    }
    setTimeout(function () {
...
function changeColor(color, accent, minor) {
    $('#Amikoko').attr('href', '/resource/ui/css/themes/theme_' + color + '.min.css');
...
function changeLang(lang) {
    $.getScript('/resource/ui/js/global/kendo.' + lang + '.js', function () {
        kendo.culture(lang);
        refresh();
    });
}

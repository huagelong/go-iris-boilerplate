...
type ArticleModel struct {
	...
	Is_delete		int		`xorm:"not null default 0 comment('是否删除,1-删除，0-未删除') TINYINT(1)" form:"is_delete"`
	CreatedAt		int		`xorm:"not null comment('创建时间') INT(11) created" form:"created_at"`
